...
void Inspector::CreateComponentUI()
{
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::CUSTOMPARTICLESYSTEM] = new ParticleSystemUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::CUSTOMPARTICLESYSTEM]->Deactivate();
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::CUSTOMPARTICLESYSTEM]);
