...
TransitionParticleSystemUI::TransitionParticleSystemUI()
	: ComponentUI("TransitionParticleSystem", "##TransitionParticleSystem", COMPONENT_TYPE::TRANSITIONPARTICLESYSTEM)
{
	SetSize(ImVec2(0.f, 1000.f));
	SetComopnentTitle("TransitionParticleSystemUI");
}
...
void TransitionParticleSystemUI::render_update()
{
	...
	auto pPS = TO->TransitionParticleSystem();
