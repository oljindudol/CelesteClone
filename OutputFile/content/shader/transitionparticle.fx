#ifndef _TRANSITIONPARTICLE
#define _TRANSITIONPARTICLE
...
[maxvertexcount(6)]
void GS_TransitionParticle(point VS_OUT _in[1], inout TriangleStream<GS_OUT> _OutStream)
{
    ...
    float4((particle.vWorldScale.x * -0.5f), 0.f, (particle.vWorldScale.y * 0.5f), 1.f);
    float4((particle.vWorldScale.x * 0.5f), 0.f, (particle.vWorldScale.y * 0.5f), 1.f);
    float4((particle.vWorldScale.x * 0.5f), 0.f, (particle.vWorldScale.y * -0.5f), 1.f);
    float4((particle.vWorldScale.x * -0.5f), 0.f, (particle.vWorldScale.y * -0.5f), 1.f);
...
float4 PS_TransitionParticle(GS_OUT _in) : SV_Target
{
